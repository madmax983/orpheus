...
| `transpose` | 2 | `transpose(semitones, pat)` | Transpose note numbers by `semitones` | `melody = transpose(12, c4 e4 g4)` |
| `pitch` | 2 | `pitch(semitones, pat)` | Shift sample playback pitch by `semitones` | `drums = bd \|> pitch(7)` |
