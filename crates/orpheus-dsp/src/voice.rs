    ...
    fn next_mono_sample(&mut self) -> Option<f32> {
        match &mut self.state {
            ...
            ActiveVoiceState::AnalogSynth {
                ...
                frame_index,
                duration_frames,
            } => Self::next_analog_synth_sample(voice, params, frame_index, *duration_frames),
...
mod tests {
    ...
    fn test_next_drum_synth_sample_panics_on_analog_voices() {
        ...
        ActiveVoice::next_drum_synth_sample(
            VoiceKind::AnalogSaw,
            &mut frame_index,
            100,
            44100.0,
    ...
    fn test_analog_voice_params_panics_on_drum_voices() {
        let trigger = super::SampleTrigger::named("bd");
        analog_voice_params(VoiceKind::KickLike, &trigger, 440.0);
    }
}
