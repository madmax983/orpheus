...
impl ValidatedPedalNode {
    /// Creates a new `ValidatedPedalNode`.
    #[must_use]
    ...
    /// Returns the underlying behavior kind of the node.
    #[must_use]
    pub const fn kind(&self) -> &PedalNodeKind {
        &self.kind
    }

    /// Returns a string summary of the node's configured behavior.
    #[must_use]
...
impl ValidatedPedalBinding {
    /// Creates a new `ValidatedPedalBinding`.
    #[must_use]
    ...
    /// Returns the underlying node of the binding.
    #[must_use]
