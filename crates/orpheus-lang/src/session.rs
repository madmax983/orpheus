...
impl ReplSession {
    ...
    fn list_midi_inputs() -> Result<String, String> {
        ...
        if port_names.is_empty() {
            ...
            let mut formatted = String::with_capacity(port_names.len() * 16 + 28);
            formatted.push_str("available MIDI input ports: ");
    ...
    fn list_midi_outputs() -> Result<String, String> {
        ...
        if port_names.is_empty() {
            ...
            let mut formatted = String::with_capacity(port_names.len() * 16 + 29);
            formatted.push_str("available MIDI output ports: ");
            for (i, name) in port_names.iter().enumerate() {
                if i > 0 {
                    formatted.push_str(", ");
                }
