...
impl ReplSession {
    ...
    fn import_stems(&mut self, raw_directory: &str) -> Result<String, String> {
        ...
        // ⚡ Bolt: Removed intermediate `.collect::<Vec<_>>()` allocation.
    ...
    fn list_midi_inputs() -> Result<String, String> {
        ...
        // ⚡ Bolt: Removed intermediate string allocations for joining
        ...
        if port_names.is_empty() {
            ...
            let mut names = String::with_capacity(port_names.len() * 16);
            ...
            Ok(format!("available MIDI input ports: {names}"))
        }
    }
    ...
    fn list_midi_outputs() -> Result<String, String> {
        ...
        if port_names.is_empty() {
            ...
            Ok(format!("available MIDI output ports: {names}"))
        }
    }
