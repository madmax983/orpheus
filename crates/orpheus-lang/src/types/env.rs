...
pub struct TypeScheme {
    /// The type variables bound in this scheme.
...
impl TypeScheme {
    /// Creates a new monomorphic `TypeScheme` containing no type variables.
    #[must_use]
...
impl TypeEnv {
    ...
    /// Returns an iterator over all bound `TypeScheme`s.
