...
impl TypeEnv {
    ...
    pub fn with_builtins() -> Self {
        ...
        install_sample_and_control_builtins(&mut env);
        install_cycle_alternation_builtins(&mut env, alpha);
        install_transform_builtins(&mut env, alpha);
...
fn install_sample_and_control_builtins(env: &mut TypeEnv) {
...
fn install_transform_builtins(env: &mut TypeEnv, alpha: TypeVarId) {
