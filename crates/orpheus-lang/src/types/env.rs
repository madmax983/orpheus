...
impl TypeEnv {
    ...
    pub fn with_builtins() -> Self {
        ...
        install_base_samples(&mut env);
        install_temporal_transforms(&mut env, alpha);
        install_probabilistic_builtins(&mut env, alpha);
        install_scale_builtins(&mut env, alpha);
        install_effects_and_controls(&mut env);
...
fn install_scale_builtins(env: &mut TypeEnv, alpha: TypeVarId) {
...
fn install_effects_and_controls(env: &mut TypeEnv) {
