...
fn load_file_strict_inner(
    ...
    for import in imports {
        ...
        // ⚡ Bolt: Extracting specific keys from owned module environments via `.remove`
        // prevents expensive deep copies of complex AST structures (Type and Value) compared to `.get(&name).cloned()`.
