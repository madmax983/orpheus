...
/// Defines the [`Style`] used to highlight the currently active (live) pattern binding
...
/// Defines the [`Style`] used to highlight a pattern binding that is queued to play next.
///
