...
impl Explain for PluginPatternValue {
    fn explain(&self, binding_name: &str) -> String {
        ...
        table.add_row(vec![
            ...
            Cell::new(format!("{:?}", self.track_source().descriptor().format()))
                .fg(comfy_table::Color::Yellow)
                .set_alignment(CellAlignment::Right),
        ]);
        table.add_row(vec![
            Cell::new("Identifier").fg(comfy_table::Color::Cyan),
            Cell::new(self.track_source().descriptor().identifier())
                .fg(comfy_table::Color::Green)
                .set_alignment(CellAlignment::Right),
        ]);
        table.add_row(vec![
            Cell::new("Notes Scheduled").fg(comfy_table::Color::Cyan),
            Cell::new(self.track_source().notes().len().to_string())
                .fg(comfy_table::Color::Yellow)
                .set_alignment(CellAlignment::Right),
        ]);
        table.add_row(vec![
            Cell::new("Automated Parameters").fg(comfy_table::Color::Cyan),
            Cell::new(self.track_source().parameter_lanes().len().to_string())
                .fg(comfy_table::Color::Yellow)
                .set_alignment(CellAlignment::Right),
        ]);
