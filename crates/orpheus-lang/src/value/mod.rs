...
use orpheus_pattern::{CyclePattern, Event, EventStream, Rational, TimeSpan};
pub mod number_pattern;
pub mod sample_pattern;

pub use number_pattern::NumberPatternValue;
pub use sample_pattern::{SampleEvent, SamplePatternValue, PatternValueTransform, PatternRuntimeValue};
...
where
    T: crate::value::sample_pattern::PatternRuntimeValue,
{
