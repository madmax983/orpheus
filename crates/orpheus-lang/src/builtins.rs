...
impl BuiltinFn {
    #[must_use]
    /// Creates a new builtin function with the specified kind.
    ///
    /// ## Examples
    /// ```
    ...
    #[must_use]
    /// Associates a site salt with this builtin instance for deterministic randomness.
    ///
    /// ## Examples
    /// ```
    /// use orpheus_lang::value::{BuiltinFn, BuiltinKind};
    /// let builtin = BuiltinFn::new(BuiltinKind::Sometimes)
    ///     .with_site_salt(42);
    /// ```
