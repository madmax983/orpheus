...
impl BuiltinFn {
    /// Creates a new `BuiltinFn` of the given kind.
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// Attaches a site-specific salt for randomness, used by stochastic builtins
    /// to ensure deterministic evaluation based on AST position.
    #[must_use]
