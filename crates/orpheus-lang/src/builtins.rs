...
impl BuiltinFn {
    /// Creates a new `BuiltinFn` corresponding to the given built-in kind.
    #[must_use]
    ...
    /// Sets the site salt for the built-in function to enable reproducible stochastic behavior.
    #[must_use]
