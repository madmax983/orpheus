...
const REGISTERED: &[&str] = &[
    ...
    // Probabilistic
    "degrade", "degrade_by", "sometimes", "sometimes_by", "often", "rarely",
    "almost_always", "almost_never", "chaos", "rand", "irand", "choose",
    "wchoose", "pchoose", "wpchoose", "randcat", "wrandcat", "markov", "shuffle",
    "scramble",
    ...
    "jux", "through",
    // Pitch & harmony
    "chord", "invert", "drop", "degrees", "pitch_class_set", "transpose",
    "pitch", "strum", "roll", "arp", "notes",
    // Tuning
    "tuning", "load_scl", "tune",
    // Generative
    "lsystem", "wolfram",
    // Controls & effects
    "gain", "pan", "cutoff", "res", "hpf", "lpf", "drive", "pw", "delay",
    "delay_time", "delay_feedback", "reverb", "reverb_room", "reverb_damp",
    "chorus", "chorus_depth", "chorus_rate", "compressor",
    "compressor_threshold", "compressor_ratio", "onset", "rate", "sample",
    "slice", "slice_idx", "cc", "midi_cc", "p", "param", "p1", "p2", "p3", "p4",
    "vst", "au", "hex", "bin",
];
...
fn reference_path() -> PathBuf {
    ...
    PathBuf::from(env!("CARGO_MANIFEST_DIR"))
        .join("../../docs/reference/language-reference.md")
}
