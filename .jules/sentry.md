...
## 2024-05-18 - [Path Case Sensitivity]
**Learning:** Checking for substrings like "VST3" on Unix/Linux systems is brittle because default installation paths (e.g., `~/.vst3`, `/usr/lib/vst3`) often use lowercase.
**Action:** Always use case-insensitive checks or check for both cases (e.g., `s.contains("VST3") || s.contains("vst3")`) when validating paths.
