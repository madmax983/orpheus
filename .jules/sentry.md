...
## 2024-07-11 - Add missing tests for format_modified_source_into and format_polymeter_source_into
**Learning:** Evaluated code coverage and noticed missing tests for standard `format_modified_source_into` and `format_polymeter_source_into` in `crates/orpheus-lang/src/pedal.rs`.
**Action:** Identify untested functions and add basic roundtrip tests to make sure formatting logic isn't silently broken.
