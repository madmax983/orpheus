...
## 2026-07-23 - Add tests for dot export errors
**Learning:** Found that `export_pedal_value_to_dot` didn't have tests for its file permission / IO error mapping to `EvalError`.
**Action:** Add test `dot_exporter_returns_error_on_invalid_path` to verify `EvalError` occurs when writing to invalid paths.
