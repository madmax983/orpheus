...
**[occurs Type Cloning]\n**Learning:** The occurs check in type inference was calling resolve(ty.clone()) which caused deep allocations of Type trees during ast traversal. \n**Action:** Replaced clone with a loop passing by reference to eliminate allocations.
