...
**[BufWriter and direct write optimizations]
**Learning:** Using Vec::new() and pushing dynamically formatted strings into it within hot loops incurs unnecessary heap allocations. Using BufWriter and writing directly to the stream prevents this.
**Action:** Always prefer formatting directly into a buffer instead of accumulating strings in memory.
