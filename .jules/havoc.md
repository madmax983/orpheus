...
**[Path OS-agnostic Assertion]**
**Learning:** Checking cross-platform OS paths strictly for casing can result in failing tests.
**Action:** Lowercase strings before assertion checking cross-platform.
